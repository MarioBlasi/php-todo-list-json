            ...
            <div class="col-6 shadow pt-5 bg-light">
                <ul class="">
                    ...
                    <li v-for="task in tasks">
                        ...
                        {{task.text}} <i class="fa-solid fa-trash"></i>
                        </span>
                </li><hr>
                </ul>
            </div>
        ...
        <div class="row ">
            ...
            <nav class="navbar navbar-light bg-light">
                    <form class="add_task form-inline d-flex ">
                        <input class="form-control mr-sm-2" aria-label="inserisci" type="text" v-model="newTask" @keyup.enter="add_task" placeholder="task here">
